          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <div class="navbar-nav">
                ...
                <li class="nav-item <?php echo request()->is('aboutus') ? 'active' : ''; ?>">
                  <a class="nav-link" href="/aboutus">About Us</a>
                </li>
                <li class="nav-item <?php echo request()->is('articles') ? 'active' : ''; ?>">
                  <a class="nav-link" href="/articles">Articles</a>
                </li>
                <li class="nav-item <?php echo request()->is('education') ? 'active' : ''; ?>">
        ...
        <div class="auth">
          <?php if (Auth::check()): ?>
              ...
              <form method="POST" action="<?php echo route('logout'); ?>" style="display: inline;">
                  <?php echo csrf_field(); ?>
                  <a class="nav-link" href="<?php echo route('logout'); ?>" onclick="event.preventDefault(); this.closest('form').submit();">Log Out</a>
              </form>
          <?php else: ?>
              <a class="nav-link" class="same-link-class" href="/login">Login</a>
              <a class="nav-link" class="same-link-class" href="/register">Register</a>
          <?php endif; ?>
      </div>
